...
contains(AGENTSMITHCOIN_NEED_QT_PLUGINS, 1) {
    DEFINES += AGENTSMITHCOIN_NEED_QT_PLUGINS
...
macx:ICON = src/qt/res/icons/AgentSmithCoin.icns
macx:TARGET = "AgentSmithCoin-Qt"
