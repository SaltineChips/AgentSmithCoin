    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("AgentSmithCoin") + " - " + tr("Client"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("AgentSmithCoin");
    setStyleSheet("#AgentSmithCoin {background-image: url(:/images/qt) }"); //qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #499bea, stop: 1 #207ce5
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a AgentSmithCoin address"));
    ...
    aboutAction = new QAction(QIcon(":icons/AgentSmithCoin"), tr("&About AgentSmithCoin"), this);
    aboutAction->setToolTip(tr("Show information about AgentSmithCoin"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for AgentSmithCoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/AgentSmithCoin"), tr("&Show / Hide"), this);
    ...
    editConfigAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit AgentSmithCoin.conf"), this);
    editConfigAction->setToolTip(tr("Edit the configuration file for AgentSmithCoin"));
    editConfigExtAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit AgentSmithCoin.conf (external)"), this);
    editConfigExtAction->setToolTip(tr("Edit the configuration file for AgentSmithCoin (external editor)"));
    openDataDirAction = new QAction(QIcon(":/icons/folder"), tr("&Open data dir"), this);
    openDataDirAction->setToolTip(tr("Open the directory where AgentSmithCoin data is stored"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("AgentSmithCoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("AgentSmithCoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AgentSmithCoin network", "", count));
}
...
{
    QString strTitle = tr("AgentSmithCoin") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid AgentSmithCoin address or malformed URI parameters."));
    }
