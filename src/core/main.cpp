...
#if defined(NDEBUG)
# error "AgentSmithCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "AgentSmithCoin Signed Message:\n";
...
{
    RenameThread("AgentSmithCoin-loadblk");
