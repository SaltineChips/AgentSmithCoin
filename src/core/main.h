...
#ifndef AGENTSMITHCOIN_MAIN_H
#define AGENTSMITHCOIN_MAIN_H
...
static const int64_t MAX_SINGLE_TX = 12000000 * COIN; // 12 Million (Same As Cap) chosen after how many uighurs are in China
/** Money Range Params */
...
public:
    ...
    /** Amount of AgentSmithCoin spent by this transaction.
